...
# Get player stats for whole league 
...
#make a func to handle making the plots and doing the calculations!
...
for i in range(len(top_dic)):
    button = ttk.Button(root, text=top_dic[i]['player_name'], command=lambda i=i: shotPlot(shotData[i], top_dic[i]['player_name']))
    button.pack()
